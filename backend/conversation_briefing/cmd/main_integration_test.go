...
func TestStaleConnectionsClosed(t *testing.T) {
	...
	cb.RegisterConversationBriefingServiceServer(srv, &cb.UnimplementedConversationBriefingServiceServer{})
	...
	client := cb.NewConversationBriefingServiceClient(conn)
	client.GenerateConversationBriefing(context.Background(), &cb.GenerateConversationBriefingRequest{}) //nolint:errcheck
