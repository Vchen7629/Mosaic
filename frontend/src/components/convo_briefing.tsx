...
const ConvoBriefingDisplay = ({ Name, Briefing }: SumWindowProps) => {
  return (
    <div className="pt-1.5 pb-2 w-full">
      ...
      >
        {/* Gloss sheen */}
        <div className="absolute inset-x-0 top-0 h-1/3 bg-gradient-to-b from-white/[0.04] to-transparent pointer-events-none z-0" />
        ...
        <div className="relative z-10 flex items-center justify-between px-4 pt-3 pb-2">
          <div className="flex items-center gap-2">
            {/* Visitor avatar dot */}
            <div className="w-8 h-6 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-[12px] font-bold text-white shadow-[0_2px_6px_rgba(109,40,217,0.4)] flex-shrink-0">
              {Name?.[0]?.toUpperCase()}
            </div>
